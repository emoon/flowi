...
static bool fl_item_is_hovered(struct FlItemApi* api, FlHoveredFlags flags);
...
static bool fl_item_is_active(struct FlItemApi* api);

// Is the last item focused for keyboard/gamepad navigation?
static bool fl_item_is_focused(struct FlItemApi* api);
...
static bool fl_item_is_clicked(struct FlItemApi* api);

// Is the last item visible? (items may be out of sight because of clipping/scrolling)
static bool fl_item_is_visible(struct FlItemApi* api);
...
static bool fl_item_is_edited(struct FlItemApi* api);

// Was the last item just made active (item was previously inactive).
static bool fl_item_is_activated(struct FlItemApi* api);
...
static bool fl_item_is_deactivated(struct FlItemApi* api);
...
static bool fl_item_is_deactivated_after_edit(struct FlItemApi* api);

// Was the last item open state toggled? set by TreeNode().
static bool fl_item_is_toggled_open(struct FlItemApi* api);

// Is any item hovered?
static bool fl_item_is_any_hovered(struct FlItemApi* api);

// Is any item active?
static bool fl_item_is_any_active(struct FlItemApi* api);

// Is any item focused?
static bool fl_item_is_any_focused(struct FlItemApi* api);

// Get upper-left bounding rectangle of the last item (screen space)
static FlVec2 fl_item_get_rect_min(struct FlItemApi* api);

// Get lower-right bounding rectangle of the last item (screen space)
static FlVec2 fl_item_get_rect_max(struct FlItemApi* api);

// Get size of last item
static FlVec2 fl_item_get_rect_size(struct FlItemApi* api);

// Allow last item to be overlapped by a subsequent item. sometimes useful with invisible buttons, selectables, etc. to
// catch unused area.
static void fl_item_set_allow_overlap(struct FlItemApi* api);
