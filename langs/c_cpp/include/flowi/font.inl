...
#ifdef FLOWI_STATIC
FlFont fl_font_new_from_file_impl(struct FlInternalData* priv, FlString filename, uint32_t font_size);
FlFont fl_font_new_from_file_range_impl(struct FlInternalData* priv, FlString filename, uint32_t font_size,
                                        uint16_t glyph_range_start, uint16_t glyph_range_end);
FlFont fl_font_new_from_memory_impl(struct FlInternalData* priv, FlString name, uint8_t* data, uint32_t data_size,
                                    uint32_t font_size);
...
#ifdef FLOWI_STATIC
    return fl_font_new_from_file_impl(g_flowi_font_api->priv, filename_, font_size);
#else
    return (g_flowi_font_api->new_from_file)(g_flowi_font_api->priv, filename_, font_size);
#endif
}
...
FL_INLINE FlFont fl_font_new_from_file_range(const char* filename, uint32_t font_size, uint16_t glyph_range_start,
    ...
    FlString filename_ = fl_cstr_to_flstring(filename);
#ifdef FLOWI_STATIC
    return fl_font_new_from_file_range_impl(g_flowi_font_api->priv, filename_, font_size, glyph_range_start,
                                            glyph_range_end);
#else
    return (g_flowi_font_api->new_from_file_range)(g_flowi_font_api->priv, filename_, font_size, glyph_range_start,
                                                   glyph_range_end);
#endif
}
...
#ifdef FLOWI_STATIC
    return fl_font_new_from_memory_impl(g_flowi_font_api->priv, name_, data, data_size, font_size);
#else
    return (g_flowi_font_api->new_from_memory)(g_flowi_font_api->priv, name_, data, data_size, font_size);
#endif
}
